...
export default function BookACallPage() {
  return (
    <div className="depth-canvas bg-[#FAF9F6] text-[#2C3434]">
      <section className="px-6 py-16 md:py-24">
        <div className="mx-auto max-w-[1200px]">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,0.42fr)_minmax(0,1.58fr)]">
            ...
            >
              <p className="text-[11px] font-semibold uppercase tracking-[0.32em] text-[#4A6A58]">Direct Intake</p>
              ...
              <div className="mt-10 space-y-6">
                <div className="depth-plane p-6">
                  ...
                  <ul className="mt-4 space-y-3 text-sm text-black/64">
                    <li className="flex gap-3">
                      <Clock3 className="h-4 w-4 shrink-0 text-[#4A6A58]" />
                ...
                <div className="flex items-center gap-3 rounded-[22px] px-5 py-4 depth-inset">
                  <ShieldCheck className="h-4 w-4 text-[#4A6A58]" />
