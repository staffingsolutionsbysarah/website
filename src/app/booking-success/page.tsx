  ...
  return (
    <div className="depth-canvas bg-[var(--color-bg)] text-[var(--color-dark)] min-h-[80vh] flex items-center justify-center px-6">
      ...
      >
        ...
        <h1 className="text-4xl font-medium tracking-tight mb-6">Booking Confirmed.</h1>
        <p className="text-lg text-black/60 leading-relaxed mb-10">
          Your hiring strategy call is confirmed. You should receive an email with the calendar invitation and meeting link shortly. We look forward to discussing your search.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/about#process" className="btn-secondary">
            Our Process
