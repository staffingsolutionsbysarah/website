                ...
                <div className="mb-4 flex gap-4">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="mt-2 w-full border-b border-black/12 bg-transparent px-0 py-2 text-sm text-black/82 outline-none transition placeholder:text-black/36 focus:border-[#C6A64A]"
                    />
                  </div>
                  {jobTypes.length > 1 && (
                    <div className="w-40">
                      ...
                      <select
                        ...
                        className="mt-2 w-full cursor-pointer border-b border-black/12 bg-transparent px-0 py-2 text-sm text-black/82 outline-none transition focus:border-[#C6A64A]"
                      >
